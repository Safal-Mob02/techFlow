...
import 'PurchaseQC_ItemDetailsFrom.dart';

class PurchaseQcItemList extends StatefulWidget {
  ...
  PurchaseQcItemList(
      ...
      : super(key: key);
  @override
  State<PurchaseQcItemList> createState() => _PurchaseQcItemListState();
}

class _PurchaseQcItemListState extends State<PurchaseQcItemList> {
  var urCode;
    ...
    return WillPopScope(
      onWillPop: () async {
        return await Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) =>  PurchaseQC_EntryList()));
      },
      child: Scaffold(
