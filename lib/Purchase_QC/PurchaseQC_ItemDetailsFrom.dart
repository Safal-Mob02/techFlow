...
import 'Purchase_QC_ITEM_SAVE_Response.dart';

typedef void ApiCallback();

class PurchaseQC_ItemDetailsFrom extends StatefulWidget {
  ...
  @override
  _PurchaseQC_ItemDetailsFromState createState() =>
      _PurchaseQC_ItemDetailsFromState();
}

class _PurchaseQC_ItemDetailsFromState
    extends State<PurchaseQC_ItemDetailsFrom> {
  ...
  Future<void> SaveData() async {
    ...
    var BODYDATA = {
      ...
      'Qty': widget.FormData.qty.toString(),
